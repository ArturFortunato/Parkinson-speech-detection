...
A \gls{gmmubm} classifier was trained using one dataset and tested with three others. The model yielded accuracies between 84\% and 94\% \cite{parkinson_phonemic_relevance}.
